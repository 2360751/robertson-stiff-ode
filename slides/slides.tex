...
\author{Zihan Xu \and Beixue Liang \and Yumo Li \\ Numerical Analysis of ODEs and PDEs --- Project 1}
\date{\today}
...
\end{itemize}
\vfill
\small Repository: \texttt{github.com/2360751/robertson-stiff-ode} --- all team members can explain and modify every part (viva-ready).
\end{frame}
